...
const diferenciais = [
  ...
  {
    icon: PhoneCall,
    title: "Suporte de Segunda a Segunda  ",
    description: "Atendimento via WhatsApp de Segunda a Segunda.",
  ...
  },
  {
    ...
    description: "Atendemos toda a regional Ressaca e bairros próximos.",
